...
![Postgresql mascot with Boris](../res/postgresql-mascot.jpg)
PostgreSQL Elephant with Boris, doling out mints. Nice dude. 
![VLC Man with Conor Joyce](../res/vlc-mascot-cawnj.jpg)
...
![skins and orb wearing VLC hats](../res/vlc-buddies.jpg)
Have to say, Malachy wore it better. Really brings out his autumnal complexion.

Some other stands:
![Linux on mobile stand](../res/linux-on-mobile.jpg)
![Linux on a phone](../res/linux-on-a-phone.jpg)
Linux, on mobile! 
![CQ QSO Stand](../res/cq-qso-stand.jpg)
![CQ QSO Stand 2](../res/cq-qso-stand-2.jpg)
The CQ-QSO stand, focused on radio transmission. I'm not sure what's going on here, but I like it!
![MNT Pocket Reford Stand](../res/mnt-pocket-reform-stand.jpg)
...
![Lettuce ask some questions...](../res/lettuce-ask-three-questions.JPG)
![FOSS is just communism in disguise](../res/programming-communism.jpg)
Don't forget, FOSS is communism!
![How to set up a minecraft server slide](../res/minecraft-server-talk.jpg)
Some brickies attended this talk on making a Minecraft server, and the rest is history...

![](../res/weiner-bus-malachy.jpg)